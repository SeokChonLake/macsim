...
all_knobs_c::all_knobs_c() {
	...
	KNOB_L3_REPL = new KnobTemplate< string > ("l3_repl", "LRU");
	KNOB_L3_PARTITION = new KnobTemplate< string > ("l3_partition", "none");
...
void all_knobs_c::registerKnobs(KnobsContainer *container) {
	...
	container->insertKnob( KNOB_L3_REPL );
	container->insertKnob( KNOB_L3_PARTITION );
