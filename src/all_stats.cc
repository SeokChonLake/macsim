...
all_stats_c::all_stats_c(ProcessorStatistics* procStat) {
	...
	m_L3_TOT_ACCESS_CORE = new COUNT_Stat("L3_TOT_ACCESS_CORE", "memory.stat.out", L3_TOT_ACCESS_CORE);
	m_L3_HIT_CORE = new COUNT_Stat("L3_HIT_CORE", "memory.stat.out", L3_HIT_CORE);
	m_L3_MISS_CORE = new COUNT_Stat("L3_MISS_CORE", "memory.stat.out", L3_MISS_CORE);
	m_L3_HIT_RATE_CORE = new RATIO_Stat("L3_HIT_RATE_CORE",  "memory.stat.out", L3_HIT_RATE_CORE, L3_TOT_ACCESS_CORE, procStat);
	m_L3_MISS_RATE_CORE = new RATIO_Stat("L3_MISS_RATE_CORE",  "memory.stat.out", L3_MISS_RATE_CORE, L3_TOT_ACCESS_CORE, procStat);
	m_L3_BYPASS_CORE = new COUNT_Stat("L3_BYPASS_CORE", "memory.stat.out", L3_BYPASS_CORE);
...
all_stats_c::~all_stats_c() {
	...
	delete m_L3_TOT_ACCESS_CORE;
	delete m_L3_HIT_CORE;
	delete m_L3_MISS_CORE;
	delete m_L3_HIT_RATE_CORE;
	delete m_L3_MISS_RATE_CORE;
	delete m_L3_BYPASS_CORE;
...
void all_stats_c::initialize(ProcessorStatistics* m_ProcessorStats, CoreStatistics* m_coreStatsTemplate) {
	...
	m_coreStatsTemplate->addStatistic(m_L3_TOT_ACCESS_CORE);
	m_coreStatsTemplate->addStatistic(m_L3_HIT_CORE);
	m_coreStatsTemplate->addStatistic(m_L3_MISS_CORE);
	m_coreStatsTemplate->addStatistic(m_L3_HIT_RATE_CORE);
	m_coreStatsTemplate->addStatistic(m_L3_MISS_RATE_CORE);
	m_coreStatsTemplate->addStatistic(m_L3_BYPASS_CORE);
