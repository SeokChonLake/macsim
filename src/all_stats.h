...
class all_stats_c {
	public:
		...
		COUNT_Stat* m_L3_TOT_ACCESS_CORE;
		COUNT_Stat* m_L3_HIT_CORE;
		COUNT_Stat* m_L3_MISS_CORE;
		RATIO_Stat* m_L3_HIT_RATE_CORE;
		RATIO_Stat* m_L3_MISS_RATE_CORE;
		COUNT_Stat* m_L3_BYPASS_CORE;
